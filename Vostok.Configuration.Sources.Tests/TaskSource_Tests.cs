...
namespace Vostok.Configuration.Sources.Tests
{
    ...
    internal class TaskSource_Tests
    {
        ...
        public void SetUp()
        {
            ...
            taskSource = new TaskSource<object>(currentValueObserverFactory);
        }
        ...
        public void Should_use_currentValueObserver()
        {
            ...
            taskSource.Get(observableProvider).Should().BeSameAs(result);
        }
        ...
        public void Should_throw_when_currentValueObserver_throws_twice()
        {
            ...
            new Action(() => taskSource.Get(observableProvider)).Should().Throw<Exception>();
